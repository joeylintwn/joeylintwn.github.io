...
dojo.declare("GoogleMapLayer", esri.layers.TiledMapServiceLayer,
    { 
        constructor: function (sUrl, serviceRes, nLayer, isProxy,lyer) {
            //debugger;
            this._url = sUrl;
            this._resource = null;
            this._layer = nLayer;
        ...
        getTileUrl: function (level, row, col) { 
            var sUrl;
            //console.log(this._lyer);
            sUrl = "https://mt2.google.com/vt/lyrs=" + this._lyer + "&hl=zh-TW&src=app&x=" + col + "&y=" + (row) + "&z=" + (level) + "&s=Galile";
            //m,h,s,y
            return sUrl;
        }
    });