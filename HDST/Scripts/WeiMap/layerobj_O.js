     ...
     function (declare, Evented, WMTSLayer, WMTSLayerInfo, TileInfo, Extent, SpatialReference, WMSLayer, WMSLayerInfo,
         ...
         var WeiLayer = declare("WeiLayer", [Evented], {
             ...
             _addtgosimage: function () {
                 this.url = this.url == '' ? 'http://210.242.163.56/TgosProxy/proxy.ashx?http://api.tgos.nat.gov.tw/TileAgent/F2IMAGE.aspx' : this.url;
             ...
             _addwmtsnlsc: function (aExtent) {
                 var tileInfo2 = new TileInfo({
                     ...
                     "lods": [
                      {
                          "level": "0",
                          "scale": 11811779.57593862,
                          "resolution": 3307.2984
                      }
                     , {
                         "level": "1",
                         "scale": 9449423.660750896,
                         "resolution": 2645.83872
                     }
                     , {
                         "level": "2",
                         "scale": 4724711.830375448,
                         "resolution": 1322.91936
                     }
                     , {
                         "level": "3",
                         "scale": 2362355.915187724,
                         "resolution": 661.45968
                     }
                     , {
                         "level": "4",
                         "scale": 944942.3660750897,
                         "resolution": 264.58376
                     }
                     , {
                         "level": "5",
                         "scale": 472471.18303754483,
                         "resolution": 132.29188
                     }
                     , {
                         "level": "6",
                         "scale": 236235.59151877242,
                         "resolution": 66.14608
                     }
                     , {
                         "level": "7",
                         "scale": 94494.23660750895,
                         "resolution": 26.45832
                     }
                     , {
                         "level": "8",
                         "scale": 47247.118303754476,
                         "resolution": 13.22916
                     }
                     , {
                         "level": "9",
                         "scale": 23623.559151877238,
                         "resolution": 6.61472
                     }
                     , {
                         "level": "10",
                         "scale": 9449.423660750896,
                         "resolution": 2.64572
                     }
                     , {
                         "level": "11",
                         "scale": 4724.711830375448,
                         "resolution": 1.323
                     }
                     , {
                         "level": "12",
                         "scale": 2362.355915187724,
                         "resolution": 0.66136
                     }
                     , {
                         "level": "13",
                         "scale": 1000,//944.9423660750896,
                         "resolution": 0.27832
                     }
                     ]
                 });
                 ...
                 this.url = this.url == '' ? 'https://wmts.nlsc.gov.tw/97/wmts' : this.url;
                 this.layer = new WMTSLayer(this.url, options);

                 //var urlTemplate = 'http://landmaps.nlsc.gov.tw/Maps97/wmts/EMAP3826/default/default028mm/{level}/{row}/{col}'; //'http://maps.nlsc.gov.tw/S_Maps/wmts/EMAP5_OPENDATA/default/GoogleMapsCompatible/{level}/{row}/{col}';
             ...
             _addAsoLayer: function (aExtent) {
                 ...
                 //this.url = this.url == '' ? 'http://wa.e-land.gov.tw/Proxy/proxy.ashx?http://wms.afasi.gov.tw/asofb/wms' : this.url;
