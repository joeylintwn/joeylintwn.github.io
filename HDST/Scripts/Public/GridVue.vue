      ...
      <div>
        ...
        <div v-show="SearchShow" style="width:89%;">
              ...
              <div class="form-group row w-100">
                <div class="input-group col-md-3 col-12 row no-gutters mt-1">
                  ...
                  <select class="form-control" name="querydata_UseYear" v-model="querydata.UseYear">
                    ...
                    <option
                      v-for=" (value, label)   in   UseYearDropOption"
                      :value="value"
                    >{{label}}</option>
                  </select>
                </div>
                ...
                <div class="input-group col-md-3 col-12 row no-gutters mt-1">
                  ...
                  >
                    <option value>-- 請選擇 --</option>
                    <option
                      v-for=" (value, label)   in   WaterNameDropOption"
                      :value="value"
                    >{{label}}</option>
                  </select>
                </div>
                <div class="input-group col-md-3 col-12 row no-gutters mt-1">
                  ...
                  >
                    <option value>-- 請選擇 --</option>
                    <option
                      v-for=" (value, label)   in   DropOptions.UseClass"
                      :value="value"
                    >{{label}}</option>
                  </select>
                </div>
          ...
          <div style="width:100%;margin:20px 0px; text-align:right">
             ...
             <input type="button" class="FunBtn w-auto" value="搜尋結果布點" onclick="MapPosition()" />
        ...
        <form name="myForm" @submit="SaveData">
          ...
          <div v-if="!isPopupInput" v-show="InputShow">
            <div>
                <div>
                    ...
                    <div class="input-group form-group row">
                        <div style="width:150px;" class="input-group-prepend">
                            <span class="input-group-text w-100 justify-content-start"
                                  id="editdata_HouseAddr">戶籍地址</span>
                        </div>
                        <input class="form-control"
                               style="height:auto;"
                               type="text"
                    ...
                    <div class="input-group form-group row">
                        <div style="width:150px;" class="input-group-prepend">
                            <span class="input-group-text w-100 justify-content-start"
                                ...
                                <span class="text-danger">*</span>溝渠地號
                            </span>
                        </div>
                        <div class="form-control" style="height:auto;">
                            <div class="form-row">
                    ...
                    <div class="input-group form-group row">
                        ...
                        <div class="form-control" style="height:auto;">
                            <a target="_blank"
                               :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.CadastralData">
                    ...
                    <div class="input-group form-group row">
                        ...
                        <div class="form-control" style="height:auto;">
                            <a target="_blank"
                               :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.PlaneLocation">
                    ...
                    <div class="input-group form-group row">
                        ...
                        <div class="form-control" style="height:auto;">
                            <a target="_blank"
                               :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.DesignDiagram">
                    ...
                    <div class="input-group form-group row">
                        ...
                        <div class="form-control" style="height:auto;">
                            <a target="_blank"
                               :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.Affidavit">
                    ...
                    <div class="input-group form-group row">
                        ...
                        <div class="form-control" style="height:auto;">
                            <a target="_blank"
                               :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.Consent">
                        ...
                        <div class="form-control" style="height:auto;">
                            <div v-if="editdata.CurrentPhotos">
                                <template v-for="item in  editdata.CurrentPhotos.split('/')">
                                    <a target="_blank"
                                       class="mr-2"
                                       :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + item">
                    ...
                    <template v-if="isView||!isPublic">
                        ...
                        <div class="input-group form-group row">
                            ...
                            <div class="form-control" style="height:auto;">
                                <a target="_blank"
                                   :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.SignDocument">
                        ...
                        <div class="input-group form-group row">
                            ...
                            <div class="form-control" style="height:auto;">
                                <a target="_blank"
                                   :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.CheckDocument">
                        ...
                        <!-- <div class="input-group form-group row">
                            ...
                            <div class="form-control" style="height:auto;">
                              <a
                                target="_blank"
                                :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.FilePath"
                              >
                          ...
                          <div class="input-group form-group row">
                            ...
                            <div class="form-control" style="height:auto;">
                              <a
                                target="_blank"
                                :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.LogPath"
                              >
                          ...
                          <div class="input-group form-group row">
                            ...
                            <div class="form-control" style="height:auto;">
                              <a
                                target="_blank"
                                :href="'../api/db/DownloadFiles/wb_Project/'+editdata.id + '?FileName=' + editdata.ImagePath"
                              >
            ...
            <div style="width:100%;margin:20px 0px; text-align:center">
              <input type="submit" class="btn btn-primary" value="儲存" :disabled="isView" />
              <input type="button" class="btn btn-warning" value="清除" @click="FormClear()" />
            </div>
          </div>
        </form>
      </div>
...
function VueDetail(scope) {
  ...
  scope.FormClear = function () {
    ...
    scope.editdata.CreatUser = UserName;
  };
